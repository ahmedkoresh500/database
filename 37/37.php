...
/*
    ...
    * [phpmyadmin]:
        ...
        =>> SELECT * FROM try2 WHERE id BETWEEN 2 AND 5;    [2] inlcuded  =>> [5] included
        =>> SELECT * FROM try2 WHERE id BETWEEN 3 AND 3;    [3] included
        ...
        =>> SELECT * FROM try2 WHERE id = 6 AND number = 12;                                =>> true syntax
        =>> SELECT * FROM try2 WHERE id = 6 AND date BETWEEN '2023-01-15' AND '2023-02-2';  =>> true syntax
*/
